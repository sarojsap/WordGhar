...
WSGI_APPLICATION = 'wordghar.wsgi.application'
...
LOGIN_REDIRECT_URL = 'writing_list'
...
# Add your credentials here (Use os.getenv in production!)
CLOUDINARY_STORAGE = {
...
# Tell Django to use Cloudinary for MEDIA files (uploads)
